...
style_slider(struct nk_context* ctx, struct nk_style_slider* out_style)
{
	...
	if (slider.show_buttons) {
		...
		slider.inc_symbol = (nk_symbol_type)nk_combo(ctx, symbols, NK_SYMBOL_MAX, slider.inc_symbol, 25, nk_vec2(200,200));
		nk_label(ctx, "Dec Symbol:", NK_TEXT_LEFT);
		slider.dec_symbol = (nk_symbol_type)nk_combo(ctx, symbols, NK_SYMBOL_MAX, slider.dec_symbol, 25, nk_vec2(200,200));
...
style_scrollbars(struct nk_context* ctx, struct nk_style_scrollbar* out_style, struct nk_style_scrollbar** duplicate_styles, int n_dups)
{
	...
	if (scroll.show_buttons) {
		nk_layout_row_dynamic(ctx, 30, 2);
		nk_label(ctx, "Inc Symbol:", NK_TEXT_LEFT);
		scroll.inc_symbol = (nk_symbol_type)nk_combo(ctx, symbols, NK_SYMBOL_MAX, scroll.inc_symbol, 25, nk_vec2(200,200));
		nk_label(ctx, "Dec Symbol:", NK_TEXT_LEFT);
		scroll.dec_symbol = (nk_symbol_type)nk_combo(ctx, symbols, NK_SYMBOL_MAX, scroll.dec_symbol, 25, nk_vec2(200,200));
...
style_property(struct nk_context* ctx, struct nk_style_property* out_style)
{
	...
	property.sym_left = (nk_symbol_type)nk_combo(ctx, symbols, NK_SYMBOL_MAX, property.sym_left, 25, nk_vec2(200,200));
	nk_label(ctx, "Right Symbol:", NK_TEXT_LEFT);
	property.sym_right = (nk_symbol_type)nk_combo(ctx, symbols, NK_SYMBOL_MAX, property.sym_right, 25, nk_vec2(200,200));
...
style_combo(struct nk_context* ctx, struct nk_style_combo* out_style)
{
	...
	combo.sym_normal = (nk_symbol_type)nk_combo(ctx, symbols, NK_SYMBOL_MAX, combo.sym_normal, 25, nk_vec2(200,200));
	nk_label(ctx, "Hover Symbol:", NK_TEXT_LEFT);
	combo.sym_hover = (nk_symbol_type)nk_combo(ctx, symbols, NK_SYMBOL_MAX, combo.sym_hover, 25, nk_vec2(200,200));
	nk_label(ctx, "Active Symbol:", NK_TEXT_LEFT);
	combo.sym_active = (nk_symbol_type)nk_combo(ctx, symbols, NK_SYMBOL_MAX, combo.sym_active, 25, nk_vec2(200,200));
...
style_tab(struct nk_context* ctx, struct nk_style_tab* out_style)
{
	...
	tab.sym_minimize = (nk_symbol_type)nk_combo(ctx, symbols, NK_SYMBOL_MAX, tab.sym_minimize, 25, nk_vec2(200,200));
	nk_label(ctx, "Maxmized Symbol:", NK_TEXT_LEFT);
	tab.sym_maximize = (nk_symbol_type)nk_combo(ctx, symbols, NK_SYMBOL_MAX, tab.sym_maximize, 25, nk_vec2(200,200));
...
#define NUM_ALIGNS 2
	...
	header.align = (nk_style_header_align)nk_combo(ctx, alignments, NUM_ALIGNS, header.align, 25, nk_vec2(200,200));
	}
#undef NUM_ALIGNS

	nk_label(ctx, "Close Symbol:", NK_TEXT_LEFT);
	header.close_symbol = (nk_symbol_type)nk_combo(ctx, symbols, NK_SYMBOL_MAX, header.close_symbol, 25, nk_vec2(200,200));
	nk_label(ctx, "Minimize Symbol:", NK_TEXT_LEFT);
	header.minimize_symbol = (nk_symbol_type)nk_combo(ctx, symbols, NK_SYMBOL_MAX, header.minimize_symbol, 25, nk_vec2(200,200));
	nk_label(ctx, "Maximize Symbol:", NK_TEXT_LEFT);
	header.maximize_symbol = (nk_symbol_type)nk_combo(ctx, symbols, NK_SYMBOL_MAX, header.maximize_symbol, 25, nk_vec2(200,200));
